        ...
        <div className="prose prose-lg space-y-6" style={{ color: '#4a4a4a' }}>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li><strong>International:</strong> Visit <a href="https://findahelpline.com" target="_blank" rel="noopener noreferrer nofollow" className="underline text-blue-600">findahelpline.com</a></li>
            </ul>
            <p className="mt-4">
